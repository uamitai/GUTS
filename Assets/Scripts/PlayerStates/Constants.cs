public static class Constants
{
    ...
    public const float sideJumpThreshhold = 0.4f;
    ...
    public const float recoveryCooldownDuration = 0.1f;
    public const float spinAttackDuration = 0.2f;
    public const float sideJumpDuration = 0.3f;
    public const float sideJumpCooldownDuration = 0.1f;
    ...
    public const float jumpAttackCooldown = 0.2f;
}